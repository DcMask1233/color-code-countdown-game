...
BEGIN
  ...
  FOREACH game_type IN ARRAY game_types
  LOOP
    FOREACH game_mode IN ARRAY game_modes
    LOOP
      -- Get duration for this game mode
      current_duration := (duration_map->game_mode)::INTEGER;
      ...
      VALUES (game_type, game_mode, current_period, period_start, period_end)
